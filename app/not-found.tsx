...
export default function NotFound() {
  return (
    <section className="container-page flex min-h-[60svh] flex-col items-center justify-center py-24 text-center">
      <p className="font-display text-sm font-semibold uppercase tracking-[0.2em] text-brand-700">404</p>
      ...
      <div className="mt-10 flex flex-col gap-3 sm:flex-row">
        <Link
          href="/"
          className="rounded-full bg-granite-900 px-7 py-3.5 text-sm font-medium text-granite-50 transition-colors hover:bg-brand-600"
        >
          Back home
        </Link>
        <Link
